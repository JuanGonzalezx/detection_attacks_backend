...
Las métricas mostradas en el Dashboard de NeoAstrum se derivan de la consolidación de los registros históricos en la tabla `validation\_logs`. Esta sección detalla la construcción conceptual y matemática de dichos indicadores.
