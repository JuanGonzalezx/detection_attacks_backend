...
\begin{enumerate}
    ...
    \item **ProcessFrontNode:** Descarga la imagen frontal de WhatsApp, invoca la API Gateway de AWS y transiciona a `AWAITING_BACK` si el documento es válido.
...
### 1. Lambda Proxy: receiveCodedImage
...
### 2. Clasificador de Fraude en Instancia EC2
...
### 3. Lambdas Auxiliares de Soporte
